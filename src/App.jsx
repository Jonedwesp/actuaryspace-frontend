...
// 🧠 FIRST NAME OVERRIDES: Forces first names to Full Names
...
export const CALENDAR_SOUND_DATA = "data:audio/mpeg;base64,";
...
const ProductivityDashboard = React.memo(({ trelloBuckets, trelloMembers }) => {
  ...
  if (selectedUser) {
    // STANDARD DETAIL VIEW (Data Capturers & Siya Review share this now!)
    const metrics = getUserMetrics(selectedUser);
    
    // Combine and sort cards so the closest due dates are at the top
    const allUserCards = [...metrics.activeCards, ...metrics.completedCards].sort((a, b) => {
      const timeA = getDueTimestamp(extractDueDate(a.title));
      const timeB = getDueTimestamp(extractDueDate(b.title));
      return timeA - timeB;
    });
...
const [isLiveCallActive, setIsLiveCallActive] = useState(false);
  ...
  useEffect(() => {
    ...
    const handleArmed = () => {
      ...
      // Give the user exactly 5 seconds to click "Open link in split view"
    ...
    const handleResize = () => {
      ...
      // 1. Window Expands (Split View Closed) -> Turn OFF AI
      if (isLiveCallActive && currentWidth > lastWidth + 200) {
        setIsLiveCallActive(false);
      }
      
      // 2. Window Shrinks (Split View Opened) -> Turn ON AI (if armed by a right-click)
      if (!isLiveCallActive && splitViewArmed && currentWidth < lastWidth - 200) {
        setIsLiveCallActive(true);
        window.dispatchEvent(new CustomEvent("googleMeetLaunched"));
        splitViewArmed = false; // Reset so it doesn't fire twice
      }
...
  // 👇 NEW: State to manage the currently selected event for the details modal
  ...
  const confirmDeleteEvent = async () => {
    ...
    // 🚀 NEW: Clear associated notification from the left panel immediately
...
// 🟢 NEW: State for in-app split pane workstation
  ...
  useEffect(() => {
    const handleWorkstation = (e) => {
      ...
      setSelectedEvent(null); // Closes calendar modal if workstation opens internally
    };
...
  const [gchatFilePreview, setGchatFilePreview] = useState(null); // { url, name, type }
  ...
  function toggleReaction(messageId, type) {
    ...
    setReactions((prev) => {
      ...
      try {
        localStorage.setItem("GCHAT_MY_REACTIONS", JSON.stringify(myReactionsRef.current));
      } catch (e) {}
...
/* Email */
  ...
  // 🟢 100% HAPPY VERSION: Targets specific files within the metadata array
  const handleApprove = async (fileName) => {
    // 🛡️ Guard: Ensure we have a batch to update and a filename to target
    ...
    // This instantly turns the label green under the specific PDF in the grid
    setBatchStatus(prev => {
    ...
    try {
      // 2. BACKEND SYNC
      // Calls the Netlify function to update the array in Firestore
      const res = await fetch("/.netlify/functions/firestore-approve-doc", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          batchId: batchStatus.batchId,
          fileName: fileName // 👈 Targets the specific entry in the fileMetadata array
        })
      });
      ...
      // 4. REVERT ON FAILURE
      // If the backend fails, we refresh the state to show the actual server values
      triggerSnackbar("Failed to sync approval. Please try again.");
      setGmailRefreshTrigger(p => p + 1); 
    }
  };

  // 🟢 NEW: Batch Extraction Status Polling
  ...
  useEffect(() => {
    ...
    const fetchStatus = async () => {
      try {
        ...
        const json = await res.json();
        if (isMounted && json.found) {
          // ⚡ SYNCED: The backend 'json' already contains 'extractedData' as a sub-object
          setBatchStatus(json);
        }
      } catch (e) {
...
/* 📅 Calendar State */
 ...
 // 👇 NEW: State to track which month the user is currently viewing
...
const combinedContacts = useMemo(() => {
  const merged = {};
  // Reverse the priority: History < People API < Hardcoded Map
  // This ensures the professional full name in AC_EMAIL_MAP always wins.
  ...
  allEntries.forEach(([name, email]) => {
    if (!email) return;
    const cleanEmail = email.toLowerCase().trim();
    
    // If this email is already in our map, only overwrite if the new name 
    // is "better" (longer/contains a space/isn't just the email prefix)
        ...
        if (Array.isArray(chatData.notifications)) {
          chatData.notifications.forEach(n => {
           ...
           if (!hasBeenSeen) {
              ...
              // 🛡️ RESTORE ON NEW MESSAGE: If a chat was "deleted" (hidden) but a new message arrives, bring it back.
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    async function loadSpaces() {
      try {
        ...
        if (!cancelled) {
          ...
          // 🧠 PRE-EMPTIVE RESOLVER: Sync Names AND Times on boot
    ...
    setGchatSpaces(loadedSpaces);
          ...
          // If the currently open chat was deleted elsewhere, close it
...
// 3. NAME LEARNER (The Fix for Sidebar Mismatch)
      useEffect(() => {
        // 🛡️ THE REF GUARD: Immediately stop if the space ID has changed.
        // This bypasses the async state delay that causes the "leak".
        ...
        // 2. 🧠 MASTER OVERRIDE: Check your GCHAT_ID_MAP first!
        ...
        // 3. FALLBACK: Repository / Drive / Human Learning
        let targetName = otherParticipant.sender?.displayName || "Direct Message";
        
        if (otherId === "users/112422887282158931745") {
          targetName = "Repository";
        } else if (otherType === "BOT") {
...
useEffect(() => {
 ...
 const incomingRaw = Array.isArray(json.messages) ? json.messages : [];
      ...
      // 🛡️ HISTORY FILTER: Only show messages newer than the last deletion event
      ...
      const incoming = incomingRaw
        ...
        .filter(m => new Date(m.createTime).getTime() > deleteTs) // 👈 KILL OLD MESSAGES
        .map(m => {
          const msgId = m.name || m.id;
          // 🧠 MEMORY APPLY: Transform deleted messages into tombstones instead of removing them
          if (myDeletionsRef.current.includes(msgId)) {
            return { ...m, text: "Message deleted by its author", isDeletedLocally: true };
          }
          // 🧠 MEMORY APPLY: Override text with permanently edited messages
          if (myEditsRef.current[msgId]) {
            return { ...m, text: myEditsRef.current[msgId], isEditedLocally: true };
          }
          return m;
        });

      if (!cancelled) {
        // 🛡️ RE-VERIFY SPACE: Only update state if we are still on the same space that started this fetch
     ...
     setGchatMessages((prev) => {
        ...
        // 🛡️ STRICT PAGINATION GUARD: Only set the token during the ABSOLUTE FIRST load.
        // If gchatMessages already has content, it means the poller is just refreshing the bottom.
        // We ignore the token here so we don't overwrite the history bookmark you're holding.
...
fetchLatestAndMerge();
  ...
  // 🚀 LISTEN FOR FORCE REFRESH: This catches the event from handleSend
  ...
  return () => {
    ...
    // 🛡️ FORCED CLEANUP: Ensure the next effect run starts with a clean slate
    setGchatMessages([]);
    setGchatMsgLoading(false);
  };
}, [currentView.app, gchatSelectedSpace?.id]);
// 🟢 STEP 3: Place the helper function here
const triggerGChatNotification = (msg, targetSpaceId) => {
  ...
  // Prioritize Master List for professional Full Names
...
useEffect(() => {
  const pollGmailBackground = async () => {
    try {
      ...
      // 1. FIRST RUN: Initialize the set if null, but DO NOT stop the function
      ...
      if (isFirstRun) {
        isInitialGmailSyncRef.current = false;
      }
...
 // 🔔 Poll Data Centre (Google Drive) for new instruction emails
  // 🟢 NEW: Calendar Background Poller for 30-min Meet Reminders
  ...
  useEffect(() => {
    ...
    checkUpcomingMeets();
    const intId = setInterval(checkUpcomingMeets, 60000); // Check every 60 seconds
...
    // Run immediately if no search, otherwise wait for user to finish typing
 ...
 // 📅 CALENDAR EVENTS LOADER
  useEffect(() => {
    ...
    // 👇 NEW: Calculate a 3-month window centered on the viewed month
    // This ensures all padding days at the start/end of the grid are fully populated.
  ...
  }, [currentView.app, calendarViewDate]); // 👈 NEW: Added calendarViewDate so it refetches when you click the arrows!
...
// 5. Calendar Meeting Reminder Handler
  if (n.alt === "Calendar" && n.calendarEventData) {
    ...
    // 1. Switch middle pane to the Calendar
    setCurrentView({ app: "calendar", contact: null });
    
    // 2. Shift the calendar view to the correct month so the background grid matches
    setCalendarViewDate(new Date(evDate.getFullYear(), evDate.getMonth(), 1));
    
    // 3. Open the specific event modal instantly
    setSelectedEvent(ev);
    return;
  }
};
...
const confirmDeleteGChatMessage = async () => {
    ...
    setMsgToDelete(null); // Optimistically close modal instantly
    
    // 🧠 MEMORIZE FOREVER: Save deletion to permanent memory
    myDeletionsRef.current = [...new Set([...myDeletionsRef.current, messageId])];
    try {
      localStorage.setItem("GCHAT_MY_DELETIONS", JSON.stringify(myDeletionsRef.current));
    } catch (e) {}

    try {
      // Optimistic tombstone update
...
    
    // 🧠 MEMORIZE FOREVER: Save edit to permanent memory
    myEditsRef.current[messageId] = newText.trim();
    try {
      localStorage.setItem("GCHAT_MY_EDITS", JSON.stringify(myEditsRef.current));
    } catch (e) {}
...
/* src/App.jsx - Improved handleSend */
  ...
  const currentUpload = pendingUpload; // Capture reference for background processing
  if (!text && !currentUpload) return;

  // 🚀 INSTANT UI RESET: Clear inputs immediately to eliminate perceived lag
  setInputValue("");
    ...
    try {
      ...
      if (currentUpload) {
        ...
        if (!res.ok || !json.ok) {
                ...
                // Re-prompt user only on hard failure
                alert(`Upload failed: ${json.error || "Unknown error"}`);
                reject(); 
                return;
              }
              
              // 🚀 TRIGGER SNAPPY UPDATE: Tell the message list to poll NOW
...
// 1. Debounce the search query to stop lag
  ...
  const middleContent = useMemo(() => {
    ...
    // Gmail filtering logic remains unchanged
...
// 2. Optimized GChat filtering using the DEBOUNCED value
...
                        const initials = String(m || "U").split(' ').map(n => n?.[0] || "").join('').substring(0, 2).toUpperCase();
            ...
            {/* 🟢 NEW: TEMPORARY POWER-UP DATA VIEWER */}
            {c.powerUpData && (
               <div className="trello-section">
                  ...
                  <div className="trello-section-header">
                     <h3 className="trello-h3">Activity Power-Up Data</h3>
                  </div>
                  <pre style={{ background: "#f4f5f7", padding: "12px", borderRadius: "4px", fontSize: "12px", overflowX: "auto", whiteSpace: "pre-wrap", wordWrap: "break-word" }}>
                     {JSON.stringify(c.powerUpData, null, 2)}
                  </pre>
               </div>
            )}
            ...
            <div className="trello-section">
               ...
               <div className="cf-grid">
                  ...
                  <div className="cf-item">
                     ...
                     <select 
                        className={`cf-select-box ${getCFColorClass("Priority", fields.Priority || fields.priority)}`}
                  ...
                  <div className="cf-item">
                     ...
                     <select 
                        className={`cf-select-box ${getCFColorClass("Status", fields.Status || fields.status)}`}
                  ...
                  <div className="cf-item">
                     ...
                     <select 
                        className={`cf-select-box ${getCFColorClass("Active", fields.Active || fields.active)}`}
                     ...
                     <div style={{ color: '#5e6c84', fontSize: '13px', fontWeight: 600, padding: '6px 12px', background: '#091e420f', borderRadius: '4px' }}>
                      ...
                      <button 
                        ...
                        onClick={async () => {
                           ...
                           // 🛡️ Lock UI state so it doesn't flicker during refresh
