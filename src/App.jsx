...
try {
  ...
  if (alt === "Gmail") {
    ...
    soundData = GCHAT_SOUND_DATA; // 👈 Make sure this variable is defined at the top!
  }
...
const handleStartChat = async () => {
    const targetEmail = newChatTarget.trim() || newChatEmailRef.current?.value || "";
                    ...
                    {Object.entries(combinedContacts)
                      ...
                      .map(([name, email]) => (
                        ...
                        >
                          ...
                          <span style={{ color: "#5f6368", fontSize: "12px", marginLeft: "15px" }}>{email}</span>
                        </div>
                      ))
                    }
...
{!gchatLoading && gchatSpaces.map((s) => {
            ...
            if (s.type === "DIRECT_MESSAGE") {
               if (learnedName && learnedName !== "Direct Message" && !learnedName.includes("users/")) {
                 title = learnedName;
               } else if (s.displayName && !s.displayName.includes("users/")) {
                 title = s.displayName;
               } else {
...
                        >
                          ...
                          {hoveredMsgId === msgId && !editingMsgId && (
                            <div className="gchat-hover-actions" style={{
                              ...
                              <button title="Heart" onClick={(e) => { e.stopPropagation(); toggleReaction(msgId, "heart"); }} style={{border:'none', background:'none', cursor:'pointer', fontSize: '16px'}}>❤️</button>
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#fff" }}>
                    ...
                    <textarea
                      ...
                      style={{ 
                        ...
                        background: "transparent",
                        color: "#202124", // Standard visible text restores selection highlighting
                        whiteSpace: "pre-wrap",
                        overflowY: "auto", // Restores native scrolling
...
const ActivityPane = React.memo(function ActivityPane({ cardId, currentUserAvatarUrl, trelloMembers }) {
  ...
  const handleSaveComment = async () => {
    ...
    const optimisticAction = {
      ...
      formatted: { text: `You commented`, comment: textToSave, type: "comment" }
    };
    ...
    <div style={styles.container}>
      ...
      <div style={styles.activityList}>
        ...
        {!loading && visibleActions.map(act => {
          ...
          const actionText = act.formatted.text.startsWith(act.memberCreator?.fullName) 
              ? act.formatted.text.slice((act.memberCreator?.fullName).length) 
              : ` ${act.formatted.text}`;
          ...
          return (
            <div key={act.id} style={styles.actItem}>
              <div style={{
                  ...styles.avatar, 
                  backgroundImage: resolvedAvatar ? `url(${resolvedAvatar})` : 'none',
                  display: 'grid', placeItems: 'center', color: '#172b4d', fontWeight: 600, fontSize: '14px'
              }}>
              ...
              <div style={styles.actContent}>
                 <div>
                    <span style={styles.actText}>
                      <strong style={{fontWeight: 600}}>{actorName}</strong>{actionText}
                    </span>
                 </div>
                 ...
                 {act.formatted.comment && (
                     <div style={{ display: 'flex', flexDirection: 'column' }}>
                         ...
                         <div style={{ display: 'flex', gap: '12px', fontSize: '12px', color: '#5e6c84', marginTop: '4px', marginLeft: '4px' }}>
                             <span 
                             ...
                             <span 
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        await fetch("/.netlify/functions/trello-delete-comment", {
                                            method: "POST",
