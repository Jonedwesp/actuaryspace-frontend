...
export const DONNA_TOOLS = [
  ...
  // gchat-send.js
  {
    ...
    "function": {
      ...
      "parameters": {
        "type": "object",
        "properties": {
          "space": { "type": "string", "description": "The Google Chat space ID to send the message to." },
  ...
  // gmail-message.js
  {
    ...
    "function": {
      ...
      "description": "Fetches the full content and body of a specific email. Use this when the user asks to read a specific email.",
      "parameters": {
        "type": "object",
        "properties": { "messageId": { "type": "string", "description": "The unique ID of the Gmail message." } },
        "required": ["messageId"]
      }
    }
  },
    ...
    "function": {
      ...
      "parameters": {
        ...
        "properties": {
          ...
          "targetListId": { "type": "string", "description": "The ID of the list to move the card into." },
  ...
  // trello-archive.js
  {
    ...
    "function": {
      ...
      "parameters": {
        "type": "object",
        "properties": { "cardId": { "type": "string", "description": "The ID of the Trello card to archive." } },
        "required": ["cardId"]
      }
    }
  },
    ...
    "function": {
      ...
      "parameters": {
        ...
        "properties": {
          ...
          "idList": { "type": "string", "description": "The ID of the list where the card should be created." }
        },
