exports.handler = async (event) => {
  ...
  try {
    ...
    // 👇 THE FIX: Strictly target the Activity Timer fields. No "WorkFlow" overrides!
    ...
    if (!startField || !durationField) {
      return { statusCode: 400, body: JSON.stringify({ error: "Required 'TimerStart' and 'Duration' fields not found on this board." }) };
    }
    ...
    if (action === "stop") {
      ...
      // 👇 FIX: Standardized the Trello API URL for clearing custom fields
