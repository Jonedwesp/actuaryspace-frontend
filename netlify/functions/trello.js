...
console.log("[TRELLO FUNC VERSION] 2026-01-30 vSAFE YOL-LISTS ✅");

export async function handler(event) {
  const VERSION = "2026-01-30 vSAFE YOL-LISTS";
  ...
  try {
    ...
    // ✅ Persona ALWAYS wins (these MUST match your real Trello list titles)
    const personaTitles =
      persona === "SIYA"
        ? ["Siya", "Siya - Review"]
        : persona === "YOLANDIE"
